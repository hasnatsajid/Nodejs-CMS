    ...
    <div class="row">
      <div class="col-12 text-center">
        ...
        <div class="d-flex align-items-center justify-content-center mb-5">
          <a href="/admin/dashboard" class="btn btn-secondary d-inline-flex align-items-center me-4">
...
<section class="section section-lg bg-soft pt-0">
  <div class="container">
    <div class="row justify-content-center mb-5 mb-lg-6">
      <div class="col-6 col-md-3 text-center mb-4">
        <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
          <svg class="icon icon-md text-secondary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="col-6 col-md-3 text-center">
        <div class="icon icon-shape bg-white shadow-lg rounded mb-4">
          <svg
            class="icon icon-md text-secondary"
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="js-square"
    ...
    <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-5 order-lg-2 mb-5 mb-lg-0">
          ...
          <p class="mb-4">
            Volt is built using the latest version of Bootstrap 5 and we only used Vanilla Javascript for everything including the plugins
          </p>
          <a
      ...
      <div class="col-lg-5 mb-5 mb-lg-0">
        <h2 class="h1 d-flex align-items-center">
          Kanban Board <span class="ms-3 mb-0 fs-6 badge badge-lg rounded-pill text-gray-800 bg-secondary">Pro</span>
        </h2>
    ...
    <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
      <div class="col-lg-5 order-lg-2 mb-5 mb-lg-0">
        <h2 class="h1 d-flex align-items-center">
          Mapbox <span class="ms-3 mb-0 fs-6 badge badge-lg rounded-pill text-gray-800 bg-secondary">Pro</span>
        </h2>
        <p class="mb-4 lead fw-bold">Markers and cards integration with Leaflet.js</p>
        <p class="mb-4">
          You can use this map to add markers with custom cards and show them on a map using our custom MapBox integration with Leaflet.js
        </p>
    ...
    <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
      <div class="col-lg-5 mb-5 mb-lg-0">
        <h2 class="h1 d-flex align-items-center">
          Calendar <span class="ms-3 mb-0 fs-6 badge badge-lg rounded-pill text-gray-800 bg-secondary">Pro</span>
        </h2>
        <p class="mb-4 lead fw-bold">Advanced FullCalendar.js integration</p>
        <p class="mb-4">We created a fully editable calendar where you can add, edit and delete events for your admin dashboard.</p>
        <a
  ...
  <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-6 mb-5">
        <a href="/admin/dashboard" class="page-preview scale-up-2">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card bg-white shadow-soft text-primary rounded mb-4">
          <div class="px-3 px-lg-4 py-5 text-center">
            <svg class="icon icon-md mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card bg-white shadow-soft text-primary rounded mb-4">
          <div class="px-3 px-lg-4 py-5 text-center">
            <svg class="icon icon-md mb-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 mb-lg-6">
      <div class="col-12 text-center">
        ...
        <p class="lead px-lg-8">
          We have carefully crafted the perfect folder structure to ensure that finding the files you're looking for are easily reachable and well
          organized.
        </p>
      </div>
    </div>
    <div class="row d-flex align-items-center">
      <div class="col-12 col-lg-6 mb-4">
        <div class="d-none d-lg-block mt-5">
          ...
          <p class="lead mb-4">
            Don't worry, we got you covered. We have a folder called <code class="text-danger">html&css</code> which includes only the basic HTML5, CSS3
        ...
        <ul class="d-block fmw-100 list-unstyled folder-structure">
          ...
          <li>
            <ul class="list-unstyled ps-4">
              ...
              >
                <svg
                  class="icon icon-sm me-2 text-warning"
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
                  data-icon="html5"
          ...
          <li class="d-flex align-items-center mb-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Project details and dependencies.">
            <svg
              class="icon icon-sm me-2 text-success"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="file-code"
      ...
      <div class="col-12 mt-5 d-lg-none">
        ...
        <p>
          Don't worry, we got you covered. We have a folder called <code class="text-danger">html&css</code> which includes only the basic HTML5, CSS3 and
    ...
    <div class="row justify-content-center mb-6">
      <div class="col-md-10 col-xl-9">
        ...
        <p class="mt-4 text-white text-center">
          ...
          <a class="text-white text-decoration-underline fw-bolder" href="https://themesberg.com/docs/rocket/getting-started/overview/" target="_blank"
            >documentation</a
          >
          has got you covered.
        </p>
    ...
    <div class="row">
      <div class="col-12 col-lg-8">
        ...
        <div class="d-flex align-items-center">
          <a href="https://github.com/themesberg/volt-bootstrap-5-dashboard" target="_blank" class="btn btn-gray-800 me-4"> View on GitHub </a>
        ...
        <div class="card shadow border-0 p-4 py-5 mt-lg-n5">
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush price-list">
              ...
              <li class="list-group-item d-flex align-items-center border-0 border-0 ps-0 pb-0">
                <svg class="icon icon-xs text-success me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
          ...
          <a
            ...
            <svg class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"></path>
              <path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z"></path></svg
          ></a>
          <!-- End Content -->
        </div>
      </div>
