...
const sidebarHTML = `<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
...
<div class="sidebar-inner px-4 pt-3">
  ...
  <ul class="nav flex-column pt-3 pt-md-0">
    ...
    <li class="nav-item  ${urlPath === '/' && 'active'}">
    ...
    <li class="nav-item  ${urlPath.includes('kanban') && 'active'}">
    ...
    <li class="nav-item  ${urlPath.includes('transactions') && 'active'}">
    ...
    <li class="nav-item  ${urlPath.includes('settings') && 'active'}">
    ...
    <li class="nav-item  ${urlPath.includes('calendar') && 'active'}">
    ...
    <li class="nav-item"  ${urlPath.includes('map') && 'active'}>
    ...
    <li class="nav-item">
      ...
      <div class="multi-level collapse" role="list" id="submenu-app" aria-expanded="false">
        <ul class="flex-column nav">
          <li class="nav-item  ${urlPath.includes('tables') && 'active'}">
    ...
    <li class="nav-item">
      ...
      <div class="multi-level collapse" role="list" id="submenu-components" aria-expanded="false">
        <ul class="flex-column nav">
          <li class="nav-item  ${urlPath.includes('buttons') && 'active'}">
            <a class="nav-link" href="/buttons">
              <span class="sidebar-text">Buttons</span>
            </a>
          </li>
          <li class="nav-item  ${urlPath.includes('notifications') && 'active'}">
            <a class="nav-link" href="/notifications">
              <span class="sidebar-text">Notifications</span>
            </a>
          </li>
          <li class="nav-item  ${urlPath.includes('forms') && 'active'}">
            <a class="nav-link" href="/forms">
              <span class="sidebar-text">Forms</span>
            </a>
          </li>
          <li class="nav-item  ${urlPath.includes('modals') && 'active'}">
            <a class="nav-link" href="/modals">
              <span class="sidebar-text">Modals</span>
            </a>
          </li>
          <li class="nav-item  ${urlPath.includes('typography') && 'active'}">
